...
def pointSampler(lstring, lscene, dictionaryFile, totalNumberOfResampledPts, pointsWithColor, rawPoints, rawLabels):
  ...
  for shape in lscene:
    ...
    [globalTriangleIdList, globalTriangleLabelList] = addTriangleIdToGlobalList_new(vertexList, globalVertexList, triangleList, globalTriangleIdList, globalTriangleLabelList, [labelCurrentModule])
  ...
  while(totalNumberOfResampledPts != totalSampledPointsSoFar):
    ...
    ultimateSampledPoints = newSampledPoints
    ultimateRandomPointLabels = randomPointLabels
