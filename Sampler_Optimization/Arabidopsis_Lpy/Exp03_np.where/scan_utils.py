...
def pointSampler(lstring, lscene, dictionaryFile, totalNumberOfResampledPts, pointsWithColor, rawPoints, rawLabels):
  ...
  for shape in lscene:
    ...
    [globalTriangleIdList_new, globalTriangleLabelList_new] = addTriangleIdToGlobalList_new(vertexList, globalVertexList, triangleList, globalTriangleIdList, globalTriangleLabelList, [labelCurrentModule])
    print("globalTriangleLabelList_new",globalTriangleLabelList_new)
    print("globalTriangleLabelList",globalTriangleLabelList)
